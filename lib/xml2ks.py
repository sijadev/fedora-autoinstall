...
def generate_kickstart(
    ...
    env_block = "\n".join([
        f'NOBARA_TARGET_USER="{username}"',
        f'NOBARA_PYTORCH_VENV="{pytorch_venv}"',
        f'NOBARA_VLLM_VENV="{vllm_venv}"',
        f'NOBARA_VLLM_CUDA_VERSION="{vllm_cuda_ver}"',
        f'NOBARA_VLLM_ARCH_LIST="{vllm_arch}"',
        f'NOBARA_VLLM_MODEL="{vllm_model}"',
        f'NOBARA_WS_GTK_ARGS="{ws_gtk_args}"',
        f'NOBARA_WS_ICON_ARGS="{ws_icon_args}"',
        f'NOBARA_WS_WALL_ARGS="{ws_wall_args}"',
        f'NOBARA_OMB_THEME="{omb_theme}"',
    ])
